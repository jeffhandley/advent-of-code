...
func GetPairRanges() []RangePair {
    pairs := GetPairs()
    pairRanges := []RangePair {}
    ...
    for _, pair := range pairs {
        ...
        elf1Range := Range{elf1min, elf1max}
        elf2Range := Range{elf2min, elf2max}

        pairRanges = append(pairRanges, RangePair{elf1Range, elf2Range})
    }
